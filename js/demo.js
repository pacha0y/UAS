...
$(function () {
    ...
    var subjectsArray = $.map(subjects, function (value, key) { return { value: value, data: key }; });
    ...
    $.mockjax({
        ...
        response: function (settings) {
            var query = settings.data.query,
                ...
                suggestions = $.grep(subjectsArray, function (subject) {
                     // return subject.value.toLowerCase().indexOf(queryLowerCase) === 0;
                    return re.test(subject.value);
                }),
                response = {
                    query: query,
