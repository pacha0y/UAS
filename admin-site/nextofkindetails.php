		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<div id="boundary">
						<ul id="nav">
							<li class="cur">Candidate details</li>
							...
							<li><a href="step4.html">Payment details</a></li>
						</ul>
						<div id="content">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									Mobile: 0999221620
									<p class="nextprev"><a href="ac_recordsdetails.php">Next &raquo;</a></p>
								</div>
							</div>
						</div>
					</div>
